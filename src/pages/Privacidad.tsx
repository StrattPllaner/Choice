  ...
  return (
    <div className="contenedor-app space-y-6 pb-6">
      <header className="space-y-2">
        <h1 className="text-2xl">Aviso de privacidad</h1>
      ...
      <section aria-labelledby="responsable" className="tarjeta space-y-2 text-sm">
      ...
      <section aria-labelledby="que-datos" className="space-y-2">
        ...
        <ul className="tarjeta list-disc space-y-2 pl-5 text-sm text-texto-suave">
          <li>
            <strong className="text-texto">Tu código de alumno</strong>, el que te da tu escuela. Con eso te
            identificamos.
          </li>
          <li>
            <strong className="text-texto">Tu grado y tu estado</strong>, si los quieres poner. Son opcionales.
          </li>
          <li>
            <strong className="text-texto">Tus respuestas</strong> del mapa de exploración y de las mediciones
            de avance.
          </li>
          <li>
            <strong className="text-texto">Las carreras que guardas y las que abres</strong> dentro de la app.
          </li>
          <li>
            <strong className="text-texto">El nombre de quien te dio permiso</strong> (tu mamá, papá o tutor) y
      ...
      <section aria-labelledby="para-que" className="space-y-2">
        ...
        <div className="tarjeta space-y-2 text-sm text-texto-suave">
          <p className="font-semibold text-texto">Finalidades necesarias (sin esto la app no sirve)</p>
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Darle a tu escuela resultados <strong className="text-texto">del grupo completo</strong>, nunca los
              tuyos por separado.
            </li>
          </ul>
          <p className="font-semibold text-texto">Finalidades que puedes rechazar</p>
          <ul className="list-disc space-y-1 pl-5">
          ...
          <p>
            Puedes negarte a estas últimas desde <strong className="text-texto">Mis datos</strong> sin perder
            nada de la app.
          </p>
        </div>
      </section>
      ...
      <section aria-labelledby="donde" className="space-y-2">
        ...
        <ul className="tarjeta list-disc space-y-1 pl-5 text-sm text-texto-suave">
      ...
      <section aria-labelledby="arco" className="space-y-2">
        ...
        <div className="tarjeta space-y-2 text-sm text-texto-suave">
          <p>
            ...
            <strong className="text-texto">rectificarlos</strong> si están mal,{' '}
            <strong className="text-texto">cancelarlos</strong> (que se borren) y{' '}
            <strong className="text-texto">oponerte</strong> a ciertos usos. También puedes retirar el permiso
            cuando quieras.
          </p>
          <p>
            No tienes que mandar un correo ni esperar: está todo en la pantalla{' '}
            <strong className="text-texto">Mis datos</strong>, dentro de la app. Ahí puedes ver todo lo que
