...
export default function Impacto() {
  ...
  if (!mediciones) return <Cargando etiqueta="Abriendo la medición…" />;
  ...
  return (
    <div className="contenedor-app space-y-5">
      <h1 className="text-2xl">Mi avance</h1>
            ...
            {compararAgregados(agregar([inicial]), agregar([ultimoSeguimiento]))
              ...
              .map((fila) => (
                <li key={fila.indicador} className="tarjeta flex justify-between gap-3">
                  ...
                  <span className={fila.subirEsBueno === fila.cambio > 0 ? 'text-exito' : 'text-texto-suave'}>
                    {fila.cambio > 0 ? '+' : ''}
      ...
      <p className="tarjeta text-xs text-texto-suave">
