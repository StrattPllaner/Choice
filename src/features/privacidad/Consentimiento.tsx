...
export function Consentimiento({ onListo }: { onListo: () => void }) {
  ...
  if (paso === 'edad') {
    return (
      <div className="contenedor-app space-y-4">
        <h1 className="text-xl">Antes de guardar nada</h1>
  ...
  if (paso === 'adulto') {
    return (
      <div className="contenedor-app space-y-4">
        <h1 className="text-xl">Tu permiso</h1>
        <p className="text-tinta-suave">
        ...
        <label className="tarjeta flex items-start gap-3 text-chico">
  ...
  return (
    <div className="contenedor-app space-y-4">
      <h1 className="text-xl">Permiso de tu papá, mamá o tutor</h1>
      <p className="text-tinta-suave">
      ...
      <div className="tarjeta space-y-2 text-chico">
        <p className="font-semibold">Qué se guarda de este alumno</p>
        <ul className="list-disc space-y-1 pl-5 text-tinta-suave">
      ...
      <div>
        <label htmlFor="nombre-tutor" className="block text-chico font-semibold">
      ...
      <div>
        <label htmlFor="parentesco" className="block text-chico font-semibold">
          Parentesco
        </label>
        <input
          id="parentesco"
      ...
      <div>
        <label htmlFor="forma" className="block text-chico font-semibold">
