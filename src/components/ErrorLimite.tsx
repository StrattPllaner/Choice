  ...
  render() {
    ...
    return (
      <div className="contenedor-app py-10 text-center">
        ...
        <p className="mt-2 text-texto-suave">Vuelve a abrir la app. Lo que guardaste sigue ahí.</p>
        <button
          type="button"
          onClick={() => window.location.reload()}
          className="toque mt-6 rounded-xl2 bg-marca px-5 py-3 font-semibold text-sobre-marca"
        >
          Reintentar
        </button>
      </div>
